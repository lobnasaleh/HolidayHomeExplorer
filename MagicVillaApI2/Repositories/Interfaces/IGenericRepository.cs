...
namespace MagicVillaApI2.Repositories.Interfaces
{
    ...
    {
        public Task<List<T>> GetAllAsyncWithExpression(Expression<Func<T, bool>>? filter = null,string? includeProperties=null,
            int pagesize=0,int pagenumber=1);//law madetsh expression return all
